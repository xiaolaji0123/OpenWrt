...
git_sparse_clone main https://github.com/Lienol/openwrt-package luci-app-filebrowser luci-app-ssr-mudb-server luci-app-fileassistant
...
# MosDNS 使用v5-lua，默认的主分支不再支持lead，或者说不支持18.06
